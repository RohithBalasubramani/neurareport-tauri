...
def node_profile_data(state: SelectionState) -> dict:
    ...
    from backend.app.services.widget_intelligence.resolvers.data_shape import extract_data_shape, DataShapeProfile
...
def node_hard_filter(state: SelectionState) -> dict:
    ...
    from backend.app.services.widget_intelligence.resolvers.variant_metadata import filter_variants
...
def node_score_shape(state: SelectionState) -> dict:
    ...
    """
    from backend.app.services.widget_intelligence.resolvers.variant_metadata import score_shape_fitness
    from backend.app.services.widget_intelligence.resolvers.variant_scorer import (
...
def node_score_intent(state: SelectionState) -> dict:
    ...
    from backend.app.services.widget_intelligence.resolvers.variant_metadata import (
...
def node_rank(state: SelectionState) -> dict:
    ...
    from backend.app.services.widget_intelligence.resolvers.variant_metadata import is_variant_default
...
def node_semantic_tiebreak(state: SelectionState) -> dict:
    ...
    """
    from backend.app.services.widget_intelligence.resolvers.semantic_embedder import score_variants_semantic
...
def node_dspy_reason(state: SelectionState) -> dict:
    ...
    from backend.app.services.widget_intelligence.resolvers.dspy_reasoner import (
        reason_variant_selection, is_dspy_available,
    )
    from backend.app.services.widget_intelligence.resolvers.data_shape import shape_to_text
    from backend.app.services.widget_intelligence.resolvers.variant_metadata import VARIANT_DESCRIPTIONS
...
def node_autogen_validate(state: SelectionState) -> dict:
    ...
    """
    from backend.app.services.widget_intelligence.resolvers.autogen_validator import validate_selection
